...
import { ShieldCheck, Activity, Users, Bot, Zap, Server, Shield, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-400">System health, global audit log trails, security rules, and user management</p>
        </div>
      </div>

      {/* System Health Cards */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        <div className="glass-card rounded-2xl p-5 border border-emerald-500/30 space-y-2">
        ...
        <div className="glass-card rounded-2xl p-5 border border-orange-500/30 space-y-2">
          <span className="text-xs font-semibold text-slate-400">Groq LPU Engine</span>
          <div className="text-lg font-bold text-orange-400 flex items-center space-x-2">
        ...
        <div className="glass-card rounded-2xl p-5 border border-slate-800 space-y-2">
          <span className="text-xs font-semibold text-slate-400">Total System Agents</span>
          <div className="text-2xl font-extrabold text-white">{overview?.agents_count || 1}</div>
        </div>
      </div>
